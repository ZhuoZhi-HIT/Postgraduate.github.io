...
\end{array}} \right]
$$
where  $\left[{% raw %} {{a_x},{a_y},{a_z}}{% endraw %} \right]$ is the gravity vector measured by sensors, and  $\left[ {{e_x},{e_y},{e_z}} \right]$ is the error vector of two coordinate systems.
